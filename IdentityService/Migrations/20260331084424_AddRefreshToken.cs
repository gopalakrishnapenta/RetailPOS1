    ...
    public partial class AddRefreshToken : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "all:all", "Master System Access (Bypass)" },
                    { 2, "orders:create", "Create Sales Bills" },
                    { 3, "orders:view", "View Own Bills" },
                    { 4, "orders:view_all", "View All Bills (Admin/Manager)" },
                    { 5, "orders:finalize", "Finalize and Take Payment" },
                    ...
                    { 18, "catalog:delete", "Delete Products from Catalog" },
                    { 19, "catalog:categories:view", "View Category List" }
                });
